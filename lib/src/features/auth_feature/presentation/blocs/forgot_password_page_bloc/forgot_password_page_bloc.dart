...
class ForgotPasswordPageBloc
  ...
  ForgotPasswordPageBloc({
    required SendResetPasswordRequestUseCase sendResetPasswordRequestUseCase,
  ...
  Future<void> _handlePasswordInput(
  ...
  Future<void> _handleConfirmPasswordInput(
  ...
  Future<void> _submitCodeAndPassword(
    SubmitCodeAndPasswordEvent event,
    Emitter<ForgotPasswordPageState> emit,
  ) async {
    emit(
      state.copyWith(
    ...
    final result = await _getconfirmPasswordUseCase.call(
