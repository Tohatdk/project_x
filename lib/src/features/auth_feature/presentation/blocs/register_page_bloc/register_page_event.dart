...
class RegisterPageEvent with _$RegisterPageEvent {
  ...
  const factory RegisterPageEvent.editPassword(String password) =
      EditPasswordEvent;
  const factory RegisterPageEvent.editConfirmationPassword(
    String confirmationPassword,
  ) = EditConfimrationPasswordEvent;
  const factory RegisterPageEvent.togglePassword() = TogglePasswordEvent;
  const factory RegisterPageEvent.toggleConfirmationPassword() =
      ToggleConfirmationPasswordEvent;
